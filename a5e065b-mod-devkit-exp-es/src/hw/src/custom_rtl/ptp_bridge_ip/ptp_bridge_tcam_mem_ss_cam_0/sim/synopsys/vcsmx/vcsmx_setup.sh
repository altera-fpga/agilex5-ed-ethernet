...
# ACDS 25.1 129 linux 2025.07.09.21:41:27
...
# ----------------------------------------
# If tcam is one of several IP cores in your
...
TOP_LEVEL_NAME="tcam.tcam"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/nfs/site/disks/swuser_work_ayerramr/msgdma/tcam_patch_25_1/acds/quartus/"
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [tcam::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [tcam::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [tcam::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set libraries [dict merge $libraries [tcam::get_design_libraries]]
...
device_libraries='lpm_ver sgate_ver altera_ver altera_mf_ver altera_lnsim_ver tennm_ver tennm_hssi_ver tennm_fm_hps_ver tennm_hssi_f1_ver '
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set memory_files [concat $memory_files [tcam::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set design_files [dict merge $design_files [tcam::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set files [concat $files [tcam::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
...
set libraries [dict create]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set libraries [dict merge $libraries [tcam::get_dpi_libraries "$QSYS_SIMDIR"]]
