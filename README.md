...
For more information, refer to the [altera github doc](https://altera-fpga.github.io/rel-26.1.1/embedded-designs/agilex-5/e-series/modular-065a/ethernet/agx5e-ethernet/ug-agx5e-ethernet/).

The System Example Design supports the following design configurations on Altera Development Kits.

|SL No| Design configuration | Data-rate | Development Kit Supported | Device Family | Device Part | Release |
|-----|-----------------------|-----------|:--------------------------:|:--------------:|:-------------:|:------:|
|1.   |1-port 25GbE/10GbE           | 25GbE/10GbE     | [MK-A5E065AB32AEA](https://www.altera.com/products/devkit/po-3278/agilex-5-fpga-and-soc-e-series-065a-modular-development-kit) | Agilex™ 5 E-Series (Group A) | A5ED065AB32AE1V | [rel/26.1.1](https://github.com/altera-fpga/agilex5-ed-ethernet/tree/rel/26.1.1) |
|2.   |1-port 10GbE           | 10GbE     | [MK-A5E065BB32AEA](https://www.altera.com/products/devkit/po-3274/agilex-5-fpga-and-soc-e-series-065b-modular-development-kit) | Agilex™ 5 E-Series (Group B) | A5ED065BB32AE4S | [rel/26.1](https://github.com/altera-fpga/agilex5-ed-ethernet/tree/rel/26.1) |
...
- **Development Kit**: [Agilex™ 5 FPGA E-Series 065A Modular Development Kit (MK-A5E065AB32AEA)](https://www.altera.com/products/devkit/po-3278/agilex-5-fpga-and-soc-e-series-065a-modular-development-kit)
