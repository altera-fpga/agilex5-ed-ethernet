...
`ifndef SM_ETH_H2D0_511B_SEQ__SV
`define SM_ETH_H2D0_511B_SEQ__SV

class sm_eth_h2d0_511B_seq extends sm_eth_basic_seq;


  `uvm_object_utils(sm_eth_h2d0_511B_seq)

  sm_eth_basic_data_path_seq     seq_h;

  // ----------------------------------------------------------------------
  // ----------------------------------------------------------------------
  function new(name = "sm_eth_h2d0_511B_seq");
    super.new(name);
  endfunction: new
...
endclass: sm_eth_h2d0_511B_seq

`endif // SM_ETH_H2D0_511B_SEQ__SV
