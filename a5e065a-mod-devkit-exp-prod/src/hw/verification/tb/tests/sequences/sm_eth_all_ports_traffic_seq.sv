...
`ifndef SM_ETH_ALL_PORTS_TRAFFIC_SEQ__SV
`define SM_ETH_ALL_PORTS_TRAFFIC_SEQ__SV

class sm_eth_all_ports_traffic_seq extends sm_eth_basic_seq;

  `uvm_object_utils(sm_eth_all_ports_traffic_seq)

  sm_eth_basic_data_path_seq     seq_h;

  // ----------------------------------------------------------------------
  // ----------------------------------------------------------------------
  function new(name = "sm_eth_all_ports_traffic_seq");
    super.new(name);
  endfunction: new
...
endclass: sm_eth_all_ports_traffic_seq

`endif // SM_ETH_ALL_PORTS_TRAFFIC_SEQ__SV
