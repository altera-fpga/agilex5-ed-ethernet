...
`ifndef SM_ETH_H2D0_PATH_SEQ__SV
`define SM_ETH_H2D0_PATH_SEQ__SV

class sm_eth_h2d0_path_seq extends sm_eth_basic_seq;


  `uvm_object_utils(sm_eth_h2d0_path_seq)

  sm_eth_basic_data_path_seq     seq_h;

  // ----------------------------------------------------------------------
  // ----------------------------------------------------------------------
  function new(name = "sm_eth_h2d0_path_seq");
    super.new(name);
  endfunction: new
  ...
  task body();
    ...
    poll_eth_stats();
  endtask: body
endclass: sm_eth_h2d0_path_seq

`endif // SM_ETH_H2D0_PATH_SEQ__SV
