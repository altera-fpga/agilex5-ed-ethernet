...
module tb_top ();
  ...
  initial begin
    ...
    wait ((tb_top.dut.gen_mulit_inst[0].hssi_ss_top.u0.o_tx_lanes_stable == 1) && (tb_top.dut.gen_mulit_inst[0].hssi_ss_top.u0.o_rx_pcs_ready == 1));

    release tb_top.dut.gen_mulit_inst[0].hssi_ss_top.u0.i_reconfig_clk;
    release tb_top.dut.gen_mulit_inst[0].hssi_ss_top.u0.i_reconfig_reset ;
