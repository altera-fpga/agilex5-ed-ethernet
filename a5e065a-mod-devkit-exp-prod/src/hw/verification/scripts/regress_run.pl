...
my $scripts=`pwd`;
my $sanitytests = `echo \${ROOTDIR}/verification/tb/tests/sequences/sm_eth_virtual_seq_list.sv`;
my @tests_to_run ;
chomp $scripts;
...
my $msg = MIME::Lite->new(
    ...
    To      => $receiver,
    #Cc      => $cc_receiver,
    Subject => "Regression results for SMPLUS 25G ETH ED UVM simulations - Tool: $simulator",
  #  Data    => $msg_body,
...
my $msg = MIME::Lite->new(
    ...
    To      => $receiver,
    #Cc      => $cc_receiver,
    Subject => "Regression results for SMPLUS 10G ETH ED UVM simulations - Tool: $simulator",
  #  Data    => $msg_body,
   Type    =>"multipart/mixed",
);
