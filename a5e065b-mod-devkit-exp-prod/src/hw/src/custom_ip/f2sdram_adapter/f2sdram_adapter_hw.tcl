...
set_parameter_property ADDR_WIDTH SYSTEM_INFO "ADDR_WIDTH"
...
add_interface_port axi4_man man_araddr araddr Output ADDR_WIDTH
...
add_interface_port axi4_man man_awaddr awaddr Output ADDR_WIDTH
...
add_interface_port axi4_sub sub_araddr araddr Input ADDR_WIDTH
...
add_interface_port axi4_sub sub_awaddr awaddr Input ADDR_WIDTH
...
module ${output_name} #(
	...
	// AXI4 subordinate
	//
	input  wire \[ADDR_WIDTH-1:0\]  sub_araddr,
	...
	input  wire \[ADDR_WIDTH-1:0\]  sub_awaddr,
	...
	// AXI4 manager
	//
	output wire \[ADDR_WIDTH-1:0\]  man_araddr,
	...
	output wire \[ADDR_WIDTH-1:0\]  man_awaddr,
